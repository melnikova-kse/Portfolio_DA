...
**Description:** В проекте необходимо было провести предобработку данных, построить графики, преобразовать категориальные признаки в числовой вид. Провести отбор независимых признаков и целевую переменную для построения и обучения модели. 
...
- Уральский федеральный университет, программа профессиональной
  переподготовки "Технологии перевода" (2020 - 2022)
